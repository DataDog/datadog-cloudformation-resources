...
public class ApiClients {
    public static ApiClient V1Client(String apiKey, String applicationKey, String apiURL, String resourceName, String resourceVersion) {
        ...
        // NOTE: for now we hardcode the AWS SDK version as 2.0.1 until it's possible to get it dynamically from the SDK
        ...
        String userAgent = String.format(
            ...
            "2.0.1", resourceName, resourceVersion, originalUA
        );
