...
public class ClientFactory {
    ...
    public ApiClient createV1Client() {
        ...
        try {
            ...
            properties.load(this.getClass().getClassLoader().getResourceAsStream("com/datadog/integrations/aws/project.properties"));
            version = properties.getProperty("version");
        } catch (java.io.IOException e) {}
        return ApiClients.V1Client(apiKey, appKey, apiURL, "integrations-aws", version);
    }
}
